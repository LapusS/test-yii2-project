...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define MACHINE_NAME + "." + BASE_DOMAIN do |machine|
    ...
    # using a specific IP.
    # ip for YII2-test
    machine.vm.network "private_network", ip: "192.168.56.119"
    #
    #
    #
    #
    ...
    machine.vm.synced_folder "./", "/var/www/yii2-test.loc", type: "virtualbox"
    # machine.vm.synced_folder "./docs", "/home/vagrant/data", type: "virtualbox"
    # machine.vm.synced_folder "../data", "/vagrant_data"

    # Create a forwarded port mapping which allows access to a specific port
    # within the machine from a port on the host machine. In the example below,
    # accessing "localhost:8080" will access port 80 on the guest machine.
    machine.vm.network "forwarded_port", guest: 80, host: 8169
